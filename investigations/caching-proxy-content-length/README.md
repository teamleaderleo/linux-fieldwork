...
- Focused issue: #101
- Stacked base: #95 / PR #96 atomic publication
...
The candidate stacks on atomic publication because length failure must occur before final-name publication. It does not include path containment from #93 / PR #94.
...
Retain the stacked cache-integrity candidate. No Debian or external upstream contact is included or authorized.
