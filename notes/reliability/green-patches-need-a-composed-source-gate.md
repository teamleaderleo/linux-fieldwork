...
The gate should also keep the two non-overlap controls visible: EOF-framed responses without a declared length remain valid, while negative declared lengths are rejected before cache publication.
